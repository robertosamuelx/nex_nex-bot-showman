...
export default function Home() {
  ...
  async function getSales() {
    const res = await fetch('http://localhost:3001/salesman')
    const json = await res.json()
    setSales(json)
    return json
  }
        ...
        <div className="columns">
          <div className="column is-3 lista-de-conversas">
            <div className="barra-superior">
              <span>
                Categorizar por: <button className="button is-info" onClick={() => {
              ...
              {showMenu && 
                <div className="my-menu">
                  <ul>
                  <li><input type="checkbox" /> Não lidas</li>
                  <li><input type="checkbox" /> Vendedor</li>
                  <li><input type="checkbox" /> Pergunta</li>
                  </ul>
                </div>}
                </span>
            </div>
